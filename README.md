...
- **Media tracker sync**  
  Connect each user's [Simkl](https://simkl.com) account: playback is scrobbled, watched state and ratings are mirrored, and changes made on Simkl are pulled back into remux.
